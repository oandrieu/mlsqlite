...
test -z "$OCAMLC" && AC_MSG_ERROR(Cannot find ocamlc.)
...
test -z "$OCAMLDEP" && AC_MSG_ERROR(Cannot find ocamldep.)

#checking for ocamlmktop
AC_CHECK_PROG(OCAMLMKTOP,ocamlmktop,ocamlmktop)
test -z "$OCAMLMKTOP" && AC_MSG_WARN(Cannot find ocamlmktop.)
#checking for ocamlmklib
AC_CHECK_PROG(OCAMLMKLIB,ocamlmklib,ocamlmklib)
test -z "$OCAMLMKLIB" && AC_MSG_WARN(Cannot find ocamlmklib.)
# checking for ocamldoc
AC_CHECK_PROG(OCAMLDOC,ocamldoc,ocamldoc)
test -z "$OCAMLDOC" && AC_MSG_WARN(Cannot find ocamldoc.)
...
test -z "$OCAMLLEX" && AC_MSG_ERROR(Cannot find ocamllex.)
...
test -z "$OCAMLYACC" && AC_MSG_ERROR(Cannot find ocamlyacc.)
AC_SUBST(OCAMLLEX)
AC_SUBST(OCAMLYACC)
])
dnl
...
test -z "$OCAMLFIND" && AC_MSG_WARN(Cannot find ocamlfind.)
AC_SUBST(OCAMLFIND)
])
dnl
dnl
